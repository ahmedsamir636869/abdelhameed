      ...
      <main className="relative isolate overflow-x-clip">
          ...
          <section className="products-hero">
              ...
              <div className="products-hero-content">
                  ...
                  <p>
                      Precision wire components and industrial solutions
                      designed, manufactured, and delivered to the highest standards.
                  </p>
          ...
          <section className="product-showroom" id="product-categories">
              ...
              <div className="container">
                  ...
                  <div className="product-category-nav">
                      ...
                      <div className="product-category-nav-heading">
                          ...
                          <div>
                              ...
                              <h2>
                                  Find the right
                                  <span>wire solution.</span>
                              </h2>

                          </div>

                          <div className="product-category-nav-intro">

                              <p>
                                  Choose a product family to jump directly to its
                                  complete collection, specifications, and available formats.
                              </p>
                      ...
                      <div className="product-category-nav-grid">


                              <a href="#mesh-decks" className="product-category-nav-card">
                                  <span className="nav-card-number">
                                      01                            </span>

                                  <span className="nav-card-body">
                                      <span className="nav-card-meta">Storage &amp; logistics</span>
                                      <span className="nav-card-title">
                                          Wire Mesh Decks and Wire Containers for Storage Systems                                </span>
                                  </span>
                              ...
                              <a href="#rest-various-products" className="product-category-nav-card">
                                  <span className="nav-card-number">
                                      02                            </span>

                                  <span className="nav-card-body">
                                      <span className="nav-card-meta">Fabricated solutions</span>
                                      <span className="nav-card-title">
                                          Specialized Wire Mesh Products                                </span>
                                  </span>
                              ...
                              <a href="#shopping-baskets" className="product-category-nav-card">
                                  <span className="nav-card-number">
                                      03                            </span>

                                  <span className="nav-card-body">
                                      <span className="nav-card-meta">Retail systems</span>
                                      <span className="nav-card-title">
                                          Shopping Baskets and Display Articles for Shops and Supermarkets                                </span>
                                  </span>
                              ...
                              <a href="#wire-products" className="product-category-nav-card">
                                  <span className="nav-card-number">
                                      04                            </span>

                                  <span className="nav-card-body">
                                      <span className="nav-card-meta">Industrial components</span>
                                      <span className="nav-card-title">
                                          Various Wire Products                                </span>
                                  </span>
                              ...
                              <a href="#pan-supports" className="product-category-nav-card">
                                  <span className="nav-card-number">
                                      05                            </span>

                                  <span className="nav-card-body">
                                      <span className="nav-card-meta">Cooking appliances</span>
                                      <span className="nav-card-title">
                                          Pan Supports for Gas Cookers                                </span>
                                  </span>
                              ...
                              <a href="#gas-cooker-shelves" className="product-category-nav-card">
                                  <span className="nav-card-number">
                                      06                            </span>
                                  ...
                                  <span className="nav-card-body">
                                      <span className="nav-card-meta">Cooking appliances</span>
                                      <span className="nav-card-title">
                                          Wire Shelves for Gas Cookers                                </span>
                                  </span>
                              ...
                              <a href="#refrigerator-shelves" className="product-category-nav-card">
                                  <span className="nav-card-number">
                                      07                            </span>

                                  <span className="nav-card-body">
                                      <span className="nav-card-meta">Refrigeration</span>
                                      <span className="nav-card-title">
                                          Wire Shelves and Baskets for Fridges and Refrigerators                                </span>
                                  </span>
                              ...
                              <a href="#cable-trays" className="product-category-nav-card">
                                  <span className="nav-card-number">
                                      08                            </span>

                                  <span className="nav-card-body">
                                      <span className="nav-card-meta">Infrastructure</span>
                                      <span className="nav-card-title">
                                          Wire Cable Trays                                </span>
                                  </span>
                              ...
                              <a href="#dishwasher-racks" className="product-category-nav-card">
                                  <span className="nav-card-number">
                                      09                            </span>

                                  <span className="nav-card-body">
                                      <span className="nav-card-meta">Dishwashing</span>
                                      <span className="nav-card-title">
                                          Wire Racks for Dishwashers                                </span>
                                  </span>
                              ...
                              <a href="#protection-screens" className="product-category-nav-card">
                                  <span className="nav-card-number">
                                      10                            </span>

                                  <span className="nav-card-body">
                                      <span className="nav-card-meta">HVAC protection</span>
                                      <span className="nav-card-title">
                                          Protection Screens for Air Conditioning Units                                </span>
                                  </span>
                  ...
                  <div className="product-showroom-list">
                          ...
                          <article className="showroom-category" id="mesh-decks">

                              <div className="showroom-category-header">

                                  <span className="showroom-category-number">
                                      01                            </span>

                                  <div>

                                      <span className="showroom-category-label">
                          ...
                          <article className="showroom-category" id="rest-various-products">
                          ...
                          <article className="showroom-category" id="shopping-baskets">
                          ...
                          <article className="showroom-category" id="wire-products">
                          ...
                          <article className="showroom-category" id="pan-supports">
                          ...
                          <article className="showroom-category" id="gas-cooker-shelves">
                          ...
                          <article className="showroom-category" id="refrigerator-shelves">
                          ...
                          <article className="showroom-category" id="cable-trays">
                          ...
                          <article className="showroom-category" id="dishwasher-racks">
                          ...
                          <article className="showroom-category" id="protection-screens">
